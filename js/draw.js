...
var Bud, Leaf, anRange, bRange, bud, budList, c, cxt, getToday, h0, lColorH, lColorLA, lColorLR, lColorS, lastW, leaf, leafList, length0, makeBranch, numOfBud, numOfLoop, rLeaf, random, reduceH, reduceL, rootX, rootY, w0, weight0, _i, _j, _len, _len1;
...
for (_j = 0, _len1 = leafList.length; _j < _len1; _j++) {
  ...
  cxt.closePath();
  cxt.fillStyle = "hsla(" + lColorH + "," + lColorS + "%," + (random(lColorLA - lColorLR, lColorLA + lColorLR)) + "%,0.1)";
  cxt.fill();
}
